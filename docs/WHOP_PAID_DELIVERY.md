...
SHA-256:
0a9f28f2d4ee360583b86543da7553f07336506fb0233b6a8ed278b30d18cac1
...
```bash
YWP_APP_DOWNLOAD_URL=https://github.com/8j7y2rhzs7-sketch/YWP_os/releases/download/android-v3.3.11/YWP-OS-3.3.11.apk
EXPO_PUBLIC_APP_DOWNLOAD_URL=https://github.com/8j7y2rhzs7-sketch/YWP_os/releases/download/android-v3.3.11/YWP-OS-3.3.11.apk
WHOP_ACCESS_RECHECK_SECONDS=300
WHOP_DAY_PASS_SECONDS=86400
```
