...
1. Set `expo.version` = Android `versionName` (e.g. `3.3.8`)
2. Set Android `versionCode` and iOS `buildNumber` to the same integer (e.g. `18`)
3. Tag releases `android-v3.3.8` and (later) `ios-v3.3.8` separately
