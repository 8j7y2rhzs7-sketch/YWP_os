...
1. Set `expo.version` = Android `versionName` (e.g. `3.3.11`)
2. Set Android `versionCode` and iOS `buildNumber` to the same integer (e.g. `21`)
3. Tag releases `android-v3.3.11` and (later) `ios-v3.3.11` separately
