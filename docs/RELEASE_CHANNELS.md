...
1. Set `expo.version` = Android `versionName` (e.g. `3.3.10`)
2. Set Android `versionCode` and iOS `buildNumber` to the same integer (e.g. `20`)
3. Tag releases `android-v3.3.10` and (later) `ios-v3.3.10` separately
